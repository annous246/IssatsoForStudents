...
k=0
  ...
  let schedule_builder_tues=async(app,customttmodel,timetablesmodel,subject,type,cadency,timestamps,people)=>{
...
for(let seance in day){
  console.log("this"+day[seance].seanceName+" "+seance.type)
}
console.log("saperate")
 if(compare(day,gooday)){console.log("got")
  goodays.splice(k,1)
 }k++
  }
  ...
  let schedule_builder_wed=async(app,customttmodel,timetablesmodel,subject,type,cadency,timestamps,people)=>{
...
k=0
  ...
  let schedule_builder_thu=async(app,customttmodel,timetablesmodel,subject,type,cadency,timestamps,people)=>{
...
k=0
  ...
  let schedule_builder_fri=async(app,customttmodel,timetablesmodel,subject,type,cadency,timestamps,people)=>{
...
k=0
  ...
  let schedule_builder_sat=async(app,customttmodel,timetablesmodel,subject,type,cadency,timestamps,people)=>{
